...
indices<- data.frame( S,  H , D , J ,Dm= Smg,
                      mpd, mntd, FRic=FD$FRic, FEve= FD$FEve, 
                      FDiv= FD$FDiv, FDis= FD$FDis, Rao=FD$RaoQ,
                      AMBI, BENTIX, M_AMBI)
indices.L <- data.frame(S= S.L, H= H.L ,D= D.L ,J= J.L ,Dm= Smg.L,
                        mpd.L,mntd.L,FRic=FD.L$FRic,FEve = FD.L$FEve,
                        FDiv= FD.L$FDiv,FDis= FD.L$FDis,Rao=FD.L$RaoQ,
                        AMBI, BENTIX, M_AMBI)
